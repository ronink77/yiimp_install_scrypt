...
displayErr() {
    ...
    output " "
    output "! Asegúrate de verificar dos veces antes de presionar enter! ¡Solo tienes una oportunidad para esto!"
    output " "
    read -e -p "Ingresa la zona horaria (e.g. America/Ciudad_de_Mexico) : " TIME
    ...
    output " "
    output "Actualizando el sistema e instalando los paquetes requeridos."
    output " "
    sleep 3
    ...
    output " "
    output "Instalando servidor Nginx ."
    output " "
    sleep 3
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    output " "
    output "Instalando servidor Mariadb ."
    output " "
    sleep 3
    ...
    output " "
    output "Instalando php7.x y otros archivos necesarios."
    output " "
    sleep 3
    ...
    output " "
    output "Instalando paquetes para compilas las cryptomonedas"
    output " "
    sleep 3
    ...
    output " "
    output "Prueba para ver si se envían correos electrónicos del servidor"
    output " "
    sleep 3
